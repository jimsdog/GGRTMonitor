...
GGSmart::MonitorSession::___DoOrder(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    try
    {
        DoOrder(__p_msg, __p_idseq, __current);
        __inS.__writeEmptyParams();
        return ::Ice::DispatchOK;
    }
    catch(const ::GGSmart::InvokeFailException& __ex)
...
GGSmart::MonitorSession::___GetAllOnlineRobots(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    try
    {
        ::GGSmart::RobotSeq __ret = GetAllOnlineRobots(__current);
...
GGSmart::MonitorSession::___GetTheRobots(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    try
    {
        ::GGSmart::RobotSeq __ret = GetTheRobots(__p_idseq, __current);
        ::IceInternal::BasicStream* __os = __inS.__startWriteParams(::Ice::DefaultFormat);
        __os->write(__ret);
        __os->writePendingObjects();
        __inS.__endWriteParams(true);
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__GGSmart__MonitorSession_all, __GGSmart__MonitorSession_all + 9, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
