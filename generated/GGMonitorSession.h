...
#ifndef __E__Work_Prj_QTPrj_GGRTMonitor_generated_GGMonitorSession_h__
#define __E__Work_Prj_QTPrj_GGRTMonitor_generated_GGMonitorSession_h__
...
class AMD_MonitorSession_DoOrder : virtual public ::Ice::AMDCallback
{
public:
...
typedef ::IceUtil::Handle< ::GGSmart::AMD_MonitorSession_DoOrder> AMD_MonitorSession_DoOrderPtr;

class AMD_MonitorSession_GetAllOnlineRobots : virtual public ::Ice::AMDCallback
{
public:

    virtual void ice_response(const ::GGSmart::RobotSeq&) = 0;
};

typedef ::IceUtil::Handle< ::GGSmart::AMD_MonitorSession_GetAllOnlineRobots> AMD_MonitorSession_GetAllOnlineRobotsPtr;

class AMD_MonitorSession_GetTheRobots : virtual public ::Ice::AMDCallback
{
public:
...
typedef ::IceUtil::Handle< ::GGSmart::AMD_MonitorSession_GetTheRobots> AMD_MonitorSession_GetTheRobotsPtr;

class AMD_MonitorSession_GetAuthSubStations : virtual public ::Ice::AMDCallback
{
public:

    virtual void ice_response(const ::GGSmart::StrSubStationMap&) = 0;
};

typedef ::IceUtil::Handle< ::GGSmart::AMD_MonitorSession_GetAuthSubStations> AMD_MonitorSession_GetAuthSubStationsPtr;
...
class AMD_MonitorSession_DoOrder : public ::GGSmart::AMD_MonitorSession_DoOrder, public ::IceInternal::IncomingAsync
{
public:

    AMD_MonitorSession_DoOrder(::IceInternal::Incoming&);
...
class AMD_MonitorSession_GetAllOnlineRobots : public ::GGSmart::AMD_MonitorSession_GetAllOnlineRobots, public ::IceInternal::IncomingAsync
{
public:

    AMD_MonitorSession_GetAllOnlineRobots(::IceInternal::Incoming&);

    virtual void ice_response(const ::GGSmart::RobotSeq&);
    // COMPILERFIX: The using directive avoid compiler warnings with -Woverloaded-virtual
    using ::IceInternal::IncomingAsync::ice_exception;
    virtual void ice_exception(const ::std::exception&);
};

class AMD_MonitorSession_GetTheRobots : public ::GGSmart::AMD_MonitorSession_GetTheRobots, public ::IceInternal::IncomingAsync
{
public:

    AMD_MonitorSession_GetTheRobots(::IceInternal::Incoming&);
...
class AMD_MonitorSession_GetAuthSubStations : public ::GGSmart::AMD_MonitorSession_GetAuthSubStations, public ::IceInternal::IncomingAsync
{
public:

    AMD_MonitorSession_GetAuthSubStations(::IceInternal::Incoming&);

    virtual void ice_response(const ::GGSmart::StrSubStationMap&);
    // COMPILERFIX: The using directive avoid compiler warnings with -Woverloaded-virtual
    using ::IceInternal::IncomingAsync::ice_exception;
    virtual void ice_exception(const ::std::exception&);
};
...
class Callback_MonitorSession_GetAuthSubStations_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_MonitorSession_GetAuthSubStations_Base> Callback_MonitorSession_GetAuthSubStationsPtr;
...
public:
    ...
    ::GGSmart::StrSubStationMap GetAuthSubStations()
    {
        return GetAuthSubStations(0);
    }
    ::GGSmart::StrSubStationMap GetAuthSubStations(const ::Ice::Context& __ctx)
    {
        return GetAuthSubStations(&__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_GetAuthSubStations(const ::IceInternal::Function<void (const ::GGSmart::StrSubStationMap&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_GetAuthSubStations(0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_GetAuthSubStations(const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_GetAuthSubStations(0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_GetAuthSubStations(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::GGSmart::StrSubStationMap&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_GetAuthSubStations(&__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_GetAuthSubStations(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_GetAuthSubStations(&__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_GetAuthSubStations(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::GGSmart::StrSubStationMap&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_GetAuthSubStations()
    {
        return begin_GetAuthSubStations(0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::Ice::Context& __ctx)
    {
        return begin_GetAuthSubStations(&__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_GetAuthSubStations(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_GetAuthSubStations(&__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::GGSmart::Callback_MonitorSession_GetAuthSubStationsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_GetAuthSubStations(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::Ice::Context& __ctx, const ::GGSmart::Callback_MonitorSession_GetAuthSubStationsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_GetAuthSubStations(&__ctx, __del, __cookie);
    }

    ::GGSmart::StrSubStationMap end_GetAuthSubStations(const ::Ice::AsyncResultPtr&);
    
private:

    ::GGSmart::StrSubStationMap GetAuthSubStations(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_GetAuthSubStations(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void DoOrder_async(const ::GGSmart::AMD_MonitorSession_DoOrderPtr&, const ::GGSmart::GGOrderMsgPtr&, const ::GGSmart::StrSeq&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___DoOrder(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void GetAllOnlineRobots_async(const ::GGSmart::AMD_MonitorSession_GetAllOnlineRobotsPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___GetAllOnlineRobots(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void GetTheRobots_async(const ::GGSmart::AMD_MonitorSession_GetTheRobotsPtr&, const ::GGSmart::StrSeq&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___GetTheRobots(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void GetAuthSubStations_async(const ::GGSmart::AMD_MonitorSession_GetAuthSubStationsPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___GetAuthSubStations(::IceInternal::Incoming&, const ::Ice::Current&);
...
template<class T>
class CallbackNC_MonitorSession_GetAuthSubStations : public Callback_MonitorSession_GetAuthSubStations_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const ::GGSmart::StrSubStationMap&);

    CallbackNC_MonitorSession_GetAuthSubStations(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
...
template<class T> Callback_MonitorSession_GetAuthSubStationsPtr
newCallback_MonitorSession_GetAuthSubStations(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::GGSmart::StrSubStationMap&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MonitorSession_GetAuthSubStations<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MonitorSession_GetAuthSubStationsPtr
newCallback_MonitorSession_GetAuthSubStations(T* instance, void (T::*cb)(const ::GGSmart::StrSubStationMap&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MonitorSession_GetAuthSubStations<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_MonitorSession_GetAuthSubStations : public Callback_MonitorSession_GetAuthSubStations_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const ::GGSmart::StrSubStationMap&, const CT&);

    Callback_MonitorSession_GetAuthSubStations(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
...
template<class T, typename CT> Callback_MonitorSession_GetAuthSubStationsPtr
newCallback_MonitorSession_GetAuthSubStations(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::GGSmart::StrSubStationMap&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MonitorSession_GetAuthSubStations<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MonitorSession_GetAuthSubStationsPtr
newCallback_MonitorSession_GetAuthSubStations(T* instance, void (T::*cb)(const ::GGSmart::StrSubStationMap&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MonitorSession_GetAuthSubStations<T, CT>(instance, cb, excb, sentcb);
}
