...
#ifndef __E__Work_Prj_QTPrj_GGRTMonitor_generated_GGSmart_h__
#define __E__Work_Prj_QTPrj_GGRTMonitor_generated_GGSmart_h__
...
class SubStation;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::GGSmart::SubStation>&);
::IceProxy::Ice::Object* upCast(::IceProxy::GGSmart::SubStation*);
...
class SubStation;
::Ice::Object* upCast(::GGSmart::SubStation*);
typedef ::IceInternal::Handle< ::GGSmart::SubStation> SubStationPtr;
typedef ::IceInternal::ProxyHandle< ::IceProxy::GGSmart::SubStation> SubStationPrx;
void __patch(SubStationPtr&, const ::Ice::ObjectPtr&);
...
typedef ::std::vector< ::GGSmart::SubStationPtr> SubStationSeq;

typedef ::std::map< ::std::string, ::GGSmart::SubStationPtr> StrSubStationMap;
...
class SubStation : virtual public ::IceProxy::Ice::Object
{
public:
    
    ::IceInternal::ProxyHandle<SubStation> ice_context(const ::Ice::Context& __context) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_context(__context).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_adapterId(const ::std::string& __id) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_adapterId(__id).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_endpoints(const ::Ice::EndpointSeq& __endpoints) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_endpoints(__endpoints).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_locatorCacheTimeout(int __timeout) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_locatorCacheTimeout(__timeout).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_connectionCached(bool __cached) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_connectionCached(__cached).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_endpointSelection(::Ice::EndpointSelectionType __est) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_endpointSelection(__est).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_secure(bool __secure) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_secure(__secure).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_preferSecure(bool __preferSecure) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_preferSecure(__preferSecure).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_router(const ::Ice::RouterPrx& __router) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_router(__router).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_locator(const ::Ice::LocatorPrx& __locator) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_locator(__locator).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_collocationOptimized(bool __co) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_collocationOptimized(__co).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_twoway() const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_twoway().get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_oneway() const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_oneway().get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_batchOneway() const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_batchOneway().get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_datagram() const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_datagram().get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_batchDatagram() const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_batchDatagram().get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_compress(bool __compress) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_compress(__compress).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_timeout(int __timeout) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_timeout(__timeout).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_connectionId(const ::std::string& __id) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_connectionId(__id).get());
    }
    
    ::IceInternal::ProxyHandle<SubStation> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<SubStation*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
class SubStation : virtual public ::Ice::Object, public ::IceInternal::GCObject
{
public:

    typedef SubStationPrx ProxyType;
    typedef SubStationPtr PointerType;

    SubStation()
    {
    }

    SubStation(::Ice::Int __ice_Id, const ::std::string& __ice_Name, const ::std::string& __ice_Description, const ::GGSmart::RobotSeq& __ice_Robots) :
        Id(__ice_Id),
        Name(__ice_Name),
...
public:
    ...
    ::GGSmart::RobotSeq Robots;
protected:

    virtual ~SubStation() {}
};

inline bool operator==(const SubStation& l, const SubStation& r)
{
    return static_cast<const ::Ice::Object&>(l) == static_cast<const ::Ice::Object&>(r);
}
